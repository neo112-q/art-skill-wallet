        ...
        "/proofs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Artwork ID to fetch proofs for",
                        "name": "artwork_id",
                        "in": "query",
                        "required": true
                    }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Proof file (image/video/PDF, max 10 MB)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Artwork ID this proof belongs to",
                        "name": "artwork_id",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/proofs/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "New proof file (image/video/PDF, max 10 MB)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
